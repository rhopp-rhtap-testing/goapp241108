...
export IMAGE_URL=${IMAGE_URL-artifactory-artifactory.apps.rhopp241108.devcluster.openshift.com/rhtap-docker/goapp:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhopp-rhtap-testing/goapp241108-gitops
